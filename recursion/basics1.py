...
# Recursion
# Whenever you think you have to take some descisions from some available choices
...
# validations are very important in recursion
# eg. tree me node.left pe recursion call karne se pehle check if node.left is there or not itself **
